...
namespace MLDebugTool.Scripts.Trackers
{
    public class AgentTracker : BaseTracker
    {
        ...
        private CustomBaseAgent currentAgent;
        ...
        public AgentTracker(MlDebugTool reference, Text counterText, CanvasGroup decisionText, Toggle pauseToggle, CustomBaseAgent agent = null) : base(reference,
            counterText)
        {
            currentAgent = agent;
        ...
        private void HandleNewAgentSelected(AgentSelector agentSelector, CustomBaseAgent agent)
        {
            UnsubscribeFromEvents();
            currentAgent = agent;
            SubscribeToEvents();
        ...
        private void SubscribeToEvents()
        {
            ...
            {
                currentAgent.OnAgentDecisionRequested += HandleAgentDecisionRequested;
                currentAgent.OnAgentObservationsCollected += HandleAgentObservationsCollected;
            }
        }
        ...
        private void HandleAgentDecisionRequested(CustomBaseAgent agent, ActionBuffers actionBuffers)
        {
            actionsString.Length = 0;
            actionsString
            ...
            lastCumulativeReward = currentAgent.GetCumulativeReward();
        ...
        private void HandleAgentObservationsCollected(CustomBaseAgent agent, Dictionary<string, string> observations)
        {
            observationsString.Length = 0;
